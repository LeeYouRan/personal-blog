 ...
 <div class="yusi-logo">
                    <a href="/">
                        <h1 class="shake shake-slow">
                                                        ...
                                                        <span style="font-family:Microsoft YaHei;font-weight:bold" class="yusi-mono"><?php bloginfo('name'); ?></span>
                                                        <span style="font-family:Microsoft JhengHei" class="yusi-bloger"><?php bloginfo('description'); ?></span>
                                                    </h1>
                    </a>
    </div>
</div>
